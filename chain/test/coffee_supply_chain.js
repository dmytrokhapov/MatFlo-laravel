...
contract('CoffeeSupplyChain', function(accounts) {
	...
	async function addFarmBasicDetails(contract)
	{
		...
		var _calcualtors = ["0x148b6c3A901130A1248B748C898F183524BB4Dde"];
		var _validators = ["0x148b6c3A901130A1248B748C898F183524BB4Dde"];
		var _parts = ["Boulders Logistics", "das da"];
	...
	describe("Cultivation Activities",() => {
		...
		it("should add cultivation basic details", async() => {
			...
			const res = await addFarmBasicDetails(this.coffeeSupplyChain);
			/* Check if Event Exists */
			console.log(res)
			const event = res.logs.find(e => e.event === 'PerformCultivation');
