...
return [
    ...
    'comments' => [
        ...
        'user_field_for_author_name' => "user_name", // what field on your User model should we use when echoing out the author name? By default this should be 'name', but maybe you have it set up to use 'username' etc.
