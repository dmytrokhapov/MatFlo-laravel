      ...
      <ul class="navbar-nav ml-auto">
        ...
        <li class="nav-item dropdown">
          <a class="nav-link" data-toggle="dropdown" href="#">
            <img src="{{asset('img/user-login-img.png')}}" class="login">{{\Auth::user()->user_name}} <img src="{{asset('img/down-arrow.svg')}}" class="arrow">
          </a>
      ...
      <nav class="mt-2">
        <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
          <!-- Add icons to the links using the .nav-icon class
            ...
            <li class="nav-header title-border">APPEARANCE</li>
            <li class="nav-item">
            <a href="{{route('dashboard')}}" class="nav-link">
                <i class="nav-icon"><img src="{{asset('img/result.svg')}}"></i><p>Results</p>
            </a>
            </li>
            {{-- <li class="nav-item menu-open"> --}}
            <li class="nav-item">
                <a href="#" class="nav-link">
                  <i class="nav-icon"><img src="{{asset('img/setting.svg')}}"></i>
                  <p>Settings<i class="fas fa-angle-left right"></i></p>
                </a>
                <ul class="nav nav-treeview">
                  <li class="nav-item">
                    <a href="#" class="nav-link">
                      <i class="nav-icon"><img src="{{asset('img/result.svg')}}"></i>
                      <p>Result 1</p>
                    </a>
                  </li>
              ...
              <li class="nav-item">
                <a href="{{route('profile.change-password')}}" class="nav-link @if(Request::is('change-password')) active @endif">
                    <i class="nav-icon"><img src="{{asset('img/admin.svg')}}"></i><p>{{ucfirst(strtolower(\Auth::user()->role))}} Change Password</p>
                </a>
                </li>
