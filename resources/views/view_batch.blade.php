                                ...
                                <div class="timeline-panel" id="exporterSection">
                                    ...
                                    <div class="timeline-body">
                                        <table class="table activityData table-responsive" >
                                            ...
                                            <tr>
                                                <td colspan="3"><span>QR Code: </span></td>
                                                <td colspan="7"><img src="https://chart.googleapis.com/chart?cht=qr&chld=H|1&chs=400x400&chl={{$document->chain_address}}" class="img-responsive"  style="width:150px; height:150px;"></td>
                                            </tr>
