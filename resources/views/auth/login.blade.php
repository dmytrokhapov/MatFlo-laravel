          ...
          <form  method="POST" id="loginform" action="{{ route('login') }}">
            ...
            <div class="form-group mb-2">
                <label for="">Username</label>
                 <p><img src="{{asset('img/user.svg')}}" alt="User Image"> <input  id="email" class="form-control" type="email" name="email" value="@if(\Cookie::get('user_email') !== null){{ \Cookie::get('user_email') }}@else{{ old('email') }}@endif" placeholder="Enter Email"></p>
            </div>
            <div class="form-group mb-2">
                <label for="">Password</label>
                <p class="password">
                    <img src="{{asset('img/password.svg')}}" alt="Password Image">
                    <input id="password" class="form-control" type="password" id="password" name="password" required value="@if(\Cookie::get('user_password') !== null){{ \Cookie::get('user_password') }}@endif" placeholder="Enter Password">
            ...
            <div class="row">
                <div class="col-6">
                  <div class="icheck-primary">
                    <input type="checkbox" id="remember" name="remember" @if(\Cookie::get('user_email') !== null) checked @endif>
                    <label for="remember">
                      Remember Me
                    </label>
                  </div>
